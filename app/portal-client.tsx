...
export default function PortalClient() {
  ...
  return selectedPerson
    ? <PersonWorkspace person={selectedPerson} onBack={goHome} onLogout={logout} />
...
function PersonWorkspace({ person, onBack, onLogout }: { person: Person; onBack: () => void; onLogout: () => void }) {
